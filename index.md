...
My fairly large activities will be described here (items form
[[#High-level topics]] sections). I'm not including maitenance, private and
sensentive activities here.

This list becomes more scare, and I'm trying to don't make it super complex.

Some items will be moved into corresponding categories later.
...
- [/] [[Wengrow_-_Data_structures_and_algorithms]], read and take notes.
...
- [Sets in Python – Real Python](https://realpython.com/python-sets/), research
  article.
- [[Petzold_-_Code]], read and take notes.
...
- [[my_awesome_software_list]]
- [Thunderbird Shortcuts](https://support.mozilla.org/en-US/kb/keyboard-shortcuts-thunderbird)
- [/] [[Neovim]] - neovim note research
- [[jq]] tutorial
- `man reset`
...
- [/] Duolingo Math, on mobile device, great way to kill time usefully
...
- [[digital_electronics]], TODO: rename to electronics, research
...
- [Антон Чехов "На чужбине" Играют Гафт и Евстигнеев. Юмор Russian Humor. Anton Chekhov "Na Chuzhbine" - YouTube](https://www.youtube.com/watch?v=wWhLYC23u18)
