...
In the following sections, I'll describe the basics of [[Lua]] programming language with Q/A flashcards based on learnxinyminutes [^1] cheatsheet.
...
[^1]: [Learn Lua in Y Minutes](https://learnxinyminutes.com/lua/).
