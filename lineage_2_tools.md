...
2. Open UnrealEd.exe
3. Enjoy! Note: If you want to edit the L2Editor run options, edit UT2003.ini Note: For Prelude client use Prelude-System.zip instead.
...
If you are interested in further development of the project, you can create issues: [L2Editor issues](https://bitbucket.org/lordofdest/l2editor/issues).
...
Основано на базе гайда от Ulthar, 20 май 2011, [Devmode (режим разработчика) в клиенте Lineage | 4Game](https://4gameforum.com/threads/167651/).
...
- [ ] Unreal, lineage 2 [L2.rar - Google Диск](https://drive.google.com/file/d/1qCVqTfuZe_NQug8a2DhVePdomnN5WqaH/view?usp=sharing) проект не полностью рабочей версии под версию движка 4.23.0.
