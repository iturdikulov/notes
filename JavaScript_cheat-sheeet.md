...
In the following sections, I'll describe the basics of [[JavaScript]]
programming language with Q/A flashcards based on learnxinyminutes [^1]
cheatsheet.

## 1. Style

Which comment style used in JavaScript?
<br class="f">
```js
...
## 3. Variables, Arrays and Objects
...
[^1]: [Learn JavaScript in Y Minutes](https://learnxinyminutes.com/javascript/)
