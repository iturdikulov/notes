...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [DEF] = LAYOUT(
    APP,  KC_F1, KC_F2, KC_F3, KC_F4, KC_F5,  KC_F6, KC_F7, KC_F8, KC_F9,  KC_F10,   KC_F11,  KC_F12,   KC_PSCR, KC_SCRL, KC_PAUS,
    ...
    LSF, LSF,   KC_Z,  KC_X,  KC_C,  KC_V,  KC_B,   KC_N,  KC_M,  KCOM,  KC_DOT, KC_SLSH,         KC_RSFT, KC_RSFT /******/, KC_MPLY,
    LA_QWE, KC_LGUI, KC_LALT, KC_SPC, KC_SPC, KC_SPC /***************/, LA_SYM, KC_RALT, KC_RCTL,   KC_MPRV, KC_MNXT         , KC_MSTP
  ),

  [SYM] = LAYOUT(
    ____,     ____,    ____,   ____,   ____,    ____,      ____, ____, ____, ____, ____, ____, ____, ____, ____, ____,
    ____,     ____,    ____,   ____,   ____,    ____,      ____, ____, ____, ____, ____, ____, ____, ____, ____, ____,
    ____,      KC_ESC, KC_MS_L, KC_MS_D,   KC_MS_U, KC_MS_R,    KC_BTN1, KC_HOME, KC_UP, KC_END, KC_DEL, ____, ____, ____, ____,
    ____,       OLSHT,   OLCTL,  OLALT,  OLGUI,   KC_VOLU,    KC_BTN2,   KC_LEFT, KC_DOWN, KC_RIGHT, KC_BSPC, ____, ____,          ____,
    ____, ____,  RGB_TOG, ____,   KC_MPRV,  KC_MNXT,  KC_VOLD,  KC_MPLY, KC_PGDN, KC_PGUP, LGUI(KC_F5), KC_ENT, ____, ____, ____,
  ...
  [QWE] = LAYOUT(
    ...
    ____, ____, ____, ____, ____, ____, ____,    ____,    ____,    ____,    ____,    ____,    ____,         ____, ____, ____,
    ____, ____, ____, KC_F,    KC_P,    KC_B,    KC_J,       KC_L,       KC_U,       KC_Y,       KC_SCLN,    ____,    ____,         ____,          ____,
    ...
    DF(DEF), ____, KC_LALT, ____, ____, ____, ____,    ____,    KC_RCTL,    ____,    ____,    ____
  ),
};
