...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [SYM] = LAYOUT(
        ...
        KC_TRNS, KC_LT,   KC_LCBR, KC_LBRC, KC_LPRN, KC_EQL,  KC_RGUI, KC_ESC,  LSFT(KC_P), KC_P,    KC_TRNS, KC_TRNS,      KC_TRNS, KC_TRNS,
        KC_TRNS, KC_TRNS, KC_GT,   KC_RCBR, KC_RBRC, KC_RPRN, KC_DLR,  KC_EXLM, KC_DQUO,    KC_QUOT, KC_MINS, LSFT(KC_EQL), KC_TRNS, KC_TRNS, KC_TRNS,
