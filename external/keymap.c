...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [DEF] = LAYOUT(
    ...
    KC_TAB,   KC_Q,  KC_W,  KC_E,  KC_R,  KC_T,   KC_Y,  KC_U,  KC_I,  KC_O,   KC_P,     KC_LBRC, KC_RBRC, KC_BSLS /******/, LA_QWE,
    KC_LCTL,   KC_A,  KC_S,  KC_D,  KC_F,  KC_G,   KC_H,  KC_J,  KC_K,  KC_L,   KC_SCLN,  KC_QUOT,  KC_ENT /**************/, ____,
    LSF, LSF,   KC_Z,  KC_X,  KC_C,  KC_V,  KC_B,   KC_N,  KC_M,  KCOM,  KC_DOT, KC_SLSH,         KC_RSFT, KC_RSFT /******/, ____,
  ...
  [NUM] = LAYOUT(
    ____, ____, ____, ____, ____,  ____, ____, ____, ____, ____, ____, ____, ____, ____, ____, ____,
    ____, ____, ____, ____, ____,  ____, ____, ____, ____, ____, ____, ____, ____, ____, ____, ____,
    ____, KC_7, KC_5,   KC_END,  KC_PGUP,  KC_VOLU, ____, KC_HOME, KC_UP, KC_BTN2, ____, ____, ____, ____, ____,
    ____, OSM(MOD_LSFT), OSM(MOD_LCTL), OSM(MOD_LALT), OSM(MOD_LGUI), KC_VOLD,    ____, KC_LEFT, KC_DOWN, KC_RIGHT, ____, ____, ____,          ____,
    ____, ____, RGB_TOG, ____, KC_MPRV, KC_MNXT, KC_MPLY,  RGB_MOD, RGB_RMOD, ____, ____, ____, ____, ____, ____,
    ____, ____, ____, ____, ____,  ____, ____, ____, ____, ____, ____, ____
  ),
